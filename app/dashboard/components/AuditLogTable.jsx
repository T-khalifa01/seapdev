...
//   onPageSizeChange,
//   onSearch,
//   onRestoreSuccess, // A new prop to tell the parent to refetch data
// }) => {
//   // We'll use the same pagination UI logic
...
//         const oldData = parsedData.original;
...
//         // Return a custom display for edited records
//         return (
//           <div>
//             <strong>Edited:</strong>
//             {changes.map((change, index) => (
//               <p key={index}>
//                 Field '{change.field}' changed from '{change.oldValue}' to '{change.newValue}'.
//               </p>
//             ))}
//           </div>
//         );
...
//         // return (
//         //   <>
//         //     <p className="font-semibold">{parsed.field}</p>
//         //     <p className="text-gray-400">From: {parsed.old_value || 'NULL'}</p>
//         //     <p className="text-gray-400">To: {parsed.new_value || 'NULL'}</p>
//         //   </>
//         // );

//       }
//       else if (actionType === 'deleted') {
//         const originalRecord = parsedData.original;

//         // Select specific fields to show the user
//         const selectedFields = {
//           id: originalRecord.id,
//           name: originalRecord.full_name,
//           email: originalRecord.email,
//           state: originalRecord.state_name,
//           lga: originalRecord.lga_name || originalRecord.lga,
//           organisation: originalRecord.organisation,
//         };
//         // return (
//         //   <p>Deleted record with ID: {parsed.id}</p>
//         // );
//         return (
//           <div>
...
//               <th scope="col" className="py-3 px-6">Table</th>
...
//                   <td className="py-4 px-6 font-medium text-white">{log.id}</td>
//                   <td className="py-4 px-6">{log.action_type}</td>
//                   <td className="py-4 px-6">{log.table_name}</td>
//                   <td className="py-4 px-6">{log.original_id}</td>
//                   <td className="py-4 px-6 text-gray-300 max-w-xs truncate">
//                     {formatData(log.data, log.action_type)}
//                   </td>
//                   <td className="py-4 px-6">{log.changed_by}</td>
