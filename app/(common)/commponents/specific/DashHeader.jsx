...
//   // Use the useSession hook to get the logged-in user's info
...
//       // Close the dropdown if the click is outside the dropdown's container
...
//     };
//   }, [isDropdownOpen]); // Re-run effect when the dropdown state changes
...
//   // Show nothing if no session exists (or redirect to login on the server-side)
//   if (!session) {
//     return null;
//   }
...
//       {/* Left side: Hamburger menu icon and dynamic page title */}
//       <div className="flex items-center space-x-4">
//         {/* The slide-in menu icon will be implemented in the next step */}
...
//       {/* Right side: Language, Notifications, and User Profile */}
//       <div className="flex items-center space-x-4">
