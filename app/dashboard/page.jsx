...
//   },
// };
// // { key: 'field', label: 'Field', Sortable: false  , type: 'string'},
// //       { key: 'old_value', label: 'Old Value', Sortable: false , type: 'string' },
// //       { key: 'new_value', label: 'New Value', Sortable: false  , type: 'string'},
...
//   // // This effect listens to all changes and triggers a fetch
//   // useEffect(() => {
...
//       fetchData();
//     }
//   }, [activeKey, debouncedSearch, sort, session]); // <-- Add 'session' here
...
//       fetchData();
//     }
//   }, [page, pageSize, fetchData, session]);
...
//   // const cardData = [
//   //   { title: 'Number of LGAs filled', value: '4,352' },
//   //   { title: 'Number of investment forms filled', value: '18,450' },
//   //   { title: 'Number of contact forms', value: '12,780' },
//   //   { title: 'Number of subscribers', value: '8' },
//   // ];
...
//   //       // Update the card data state with the fetched counts
//   //       setCardData([
//   //         { title: 'Number of LGAs filled', value: data.lgaCount.toLocaleString() },
//   //         { title: 'Number of investment forms filled', value: data.investmentCount.toLocaleString() },
//   //         { title: 'Number of contact forms', value: data.contactCount.toLocaleString() },
//   //         { title: 'Number of subscribers', value: data.subscriptionsCount.toLocaleString() },
//   //       ]);
//   //     } catch (error) {
//   //       console.error("Could not fetch dashboard counts:", error);
//   //       // Set error values if the fetch fails
//   //       setCardData([
//   //         { title: 'Number of LGAs filled', value: 'Error' },
//   //         { title: 'Number of investment forms filled', value: 'Error' },
//   //         { title: 'Number of contact forms', value: 'Error' },
//   //         { title: 'Number of subscribers', value: 'Error' },
//   //       ]);
//   //     }
//   //   }
//   //   fetchCounts();
...
//     fetchDashboardData();
//   }, [auditPage, auditPageSize, auditSearch, auditSort]); // dependencies to re-fetch on change
...
//     //           <p className="text-gray-400">Pie chart and graph will go here.</p>
//     //         </div>
//     //       </section>
//     //     </>
//     //   )}
...
//           {/* This is the new section for the Audit Log Table */}
//           <section className="bg-gray-800 p-6 rounded-lg shadow-md">
//             <h3 className="text-xl font-semibold text-white mb-4">Recent Changes (Audit Log)</h3>
//             {/* <DashTable
//               title={tableConfigs.auditLog.name}
//               columns={tableConfigs.auditLog.columns}
//               rows={auditRows}
//               total={auditTotal}
...
//               onRestoreSuccess={() => { setAuditPage(1); setAuditSearch(''); fetchAuditData(); }}
//             />
//           </section>
//         </>
//       )}

//       {/* new conditional for the registration form */}
