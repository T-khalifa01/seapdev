...
export default function sitemap() {
  ...
  return [
    ...
    {
      url: `${baseUrl}/invest-Opportunities`,
      lastModified: new Date(),
      changeFrequency: "weekly",
      priority: 0.9,
    },
    {
      url: `${baseUrl}/invest-Opportunities/agric-agriBusiness`,
      lastModified: new Date(),
      changeFrequency: "weekly",
      priority: 0.9,
    },
    {
      url: `${baseUrl}/invest-Opportunities/e-Mobility`,
      lastModified: new Date(),
      changeFrequency: "weekly",
      priority: 0.9,
    },
    {
      url: `${baseUrl}/invest-Opportunities/mining`,
      lastModified: new Date(),
      changeFrequency: "weekly",
      priority: 0.9,
    },
    {
      url: `${baseUrl}/invest-Opportunities/utility-scale`,
      lastModified: new Date(),
      changeFrequency: "weekly",
      priority: 0.9,
    },
